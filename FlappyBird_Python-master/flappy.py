...
bird_downflap = pygame.transform.scale2x(pygame.image.load('FlappyBird_Python-master/assets/bluebird-downflap.png').convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load('FlappyBird_Python-master/assets/bluebird-midflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load('FlappyBird_Python-master/assets/bluebird-upflap.png').convert_alpha())
...
game_over_surface = pygame.transform.scale2x(pygame.image.load('FlappyBird_Python-master/assets/message.png').convert_alpha())
