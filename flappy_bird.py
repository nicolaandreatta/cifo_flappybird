...
def main(win, nn = None):
    ...
    while run:
        ...
        #TODO get inputs from game state
        gameStateVariables = np.array([bird.x, bird.y, bird.vel, pipes[-1].top, pipes[-1].bottom])
        print(gameStateVariables)
        print('shape:  ', gameStateVariables.shape)
        #flapProbab = nn(tf.convert_to_tensor(gameStateVariables), training=False)
